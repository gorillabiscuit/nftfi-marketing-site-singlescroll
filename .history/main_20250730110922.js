...
function initializeControls() {
    ...
    if (camera) {
        ...
        document.getElementById('cameraFOV').value = 130 - camera.fov; // Invert FOV for slider (130 - 110 = 20)
...
function updateCamera() {
    ...
    if (camera) {
        ...
        // FOV logic: slider value directly corresponds to FOV value
        // Slider range is 10-120, and we want the slider value to directly set the FOV
...
function init() {
    ...
    // Create camera
    camera = new THREE.PerspectiveCamera(110, size / size, 0.1, 1000); // FOV 110, square aspect
    camera.position.set(0, 0, 28); // Match UI defaults
