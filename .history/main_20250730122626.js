...
function updateEffects() {
    ...
    const refraction = parseFloat(document.getElementById('refractPower').value);
    
    document.getElementById('saturationValue').textContent = saturation.toFixed(2);
    document.getElementById('chromaticAberrationValue').textContent = chromaticAberration.toFixed(3);
    document.getElementById('refractPowerValue').textContent = refraction.toFixed(2);
